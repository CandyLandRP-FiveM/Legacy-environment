...
Config.JerryCanPrice = 150 -- The price of a jerry can, not including tax.
...
Config.GasStations = { -- Configuration options for various gas station related things, including peds, coords and labels.
    ...
    [28] = {
        zones = {
            vector2(455.5, -947.68),
            vector2(455.45, -936.15),
            vector2(456.69, -935.4),
            vector2(456.58, -947.79)
        },
        minz = 29.5,
        maxz = 31.9,
        ...
        electriccharger = nil,
        electricchargercoords = vector4(455.93, -944.02, 22.2, 89.01),
        label = "MRPD Fuel",
    },
    --[[
