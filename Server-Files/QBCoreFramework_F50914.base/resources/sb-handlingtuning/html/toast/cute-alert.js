...
const cuteAlert = ({
  ...
  return new Promise(resolve => {
    ...
    <div class="alert-wrapper">
      <div class="alert-frame">
        ...
        <div class="alert-body">
          ...
          ${input ? `<input class='alert-input' id='alert-input' placeholder='${input}'></input>` : ''}
          ${btnTemplate}
        </div>
      </div>
    </div>
    ...
    const inputEl = document.querySelector('#alert-input');
    ...
    if (type === 'question') {
      ...
      confirmButton.addEventListener('click', () => {
        alertWrapper.remove();
        resolve({success: true, input: inputEl ? inputEl.value : null});
      });

      cancelButton.addEventListener('click', () => {
        alertWrapper.remove();
        resolve({success: false, input: inputEl.value});
      });
    } else {
