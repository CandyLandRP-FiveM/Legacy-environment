...
local toggle_rappel = 303 -- control id to rappel out of the heli. Default: INPUT_DUCK (X)
local toggle_spotlight = 73 -- control id to toggle the front spotlight Default: INPUT_PhoneCameraGrid (G)
