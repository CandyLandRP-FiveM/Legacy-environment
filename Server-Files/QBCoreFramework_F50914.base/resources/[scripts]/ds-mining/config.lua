...
Config.UseGlobalCoolDown = false  --- Enable if you want to set mine location cooldown for all players.
Config.EyeTarget = "qb-target"  --- you can use ox_target or qb-target
Config.CoolDown = 10  ---- CoolDown in minutes for reset all locations.
