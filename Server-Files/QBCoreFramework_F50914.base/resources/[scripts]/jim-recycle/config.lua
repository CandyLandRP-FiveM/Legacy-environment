...
Config = {
	...
	Inv = "qs", -- set to "ox" if using OX Inventory
	Menu = "qb",
	ProgressBar = "qb",
	Notify = "qb",
	...
	DumpsterDiving = {
		...
		models = { -- The mighty list of dumpters/trash cans
			...
			`zprop_bin_01a_old`, `hei_heist_kit_bin_01`, `ch_prop_casino_bin_01a`, `vw_prop_vw_casino_bin_01a`, `mp_b_kit_bin_01`, `prop_bin_01a`, `prop_cs_bin_02`, 
		},
		searchTime = 3000,
	},
	...
	RecycleAmounts = {
		...
		["Trade"] = {
			{ amount = 1, itemGive = 2, Min = 2, Max = 5, },
			{ amount = 10, itemGive = 5, Min = 5, Max = 15, },
			{ amount = 100, itemGive = 8, Min = 15, Max = 25, },
		},
	}
}
