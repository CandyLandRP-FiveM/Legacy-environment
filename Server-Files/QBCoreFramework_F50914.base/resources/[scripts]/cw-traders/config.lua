...
--     tradeLabel = 'Trade 2 plastic for a dumbbitch juice',
...
local bumGuy = {
    ...
    tradeLabel = 'Trade 5 coins for a reward',
    coords = vector4(-251.81, 159.96, 21.36, 10.2),
    animation = 'WORLD_HUMAN_DRUG_DEALER_HARD',
    allowBatchTrade = false, -- example of how to enable batch trading
    batchTradeLabel = 'Trade multiple coins for a reward'
}
...
--     }, 
--     coords = vector4(1129.28, -2215.01, 31.7, 354.18),
--     animation = 'WORLD_HUMAN_DRUG_DEALER_HARD', 
-- }
