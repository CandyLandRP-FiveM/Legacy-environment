...
exports['qb-target']:AddCircleZone('randomPharmacy', selectPharmacy, 1.0, {
    ...
    options = {
        {
            ...
            action = function()
                local hasItem = exports['qs-inventory']:Search('Config.SignedPerscription')
                if hasItem then
...
exports['qb-target']:AddCircleZone('availableDoctors', Config.AvailableDoctorListLocation, 1.0, {
...
function startOxyRun:onEnter()
    spawnStartOxyRunPed()
    exports['qb-target']:AddTargetEntity(startOxyRunPed, {
        options = {
            {
                name = 'startOxyRun',
...
function startOxyRun:onExit()
    ...
    exports['qb-target']:RemoveTargetEntity(startOxyRunPed, nil)
end
