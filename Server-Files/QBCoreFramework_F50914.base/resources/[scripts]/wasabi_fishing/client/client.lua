...
CreateThread(function()
    local model = Config.sellShop.ped
    RequestModel(model)
    while not HasModelLoaded(model) do
      Wait(0)
    end
    local entity = CreatePed(28, Config.sellShop.ped, Config.sellShop.coords.x, Config.sellShop.coords.y, Config.sellShop.coords.z, Config.sellShop.heading, false, false)
