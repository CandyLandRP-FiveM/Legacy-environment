...
Config.DisableHeadshot = false              -- Set true it will remove heatshots (Requiere server restart)
Config.RemovePistolWhipping = true          -- Remove weapon whipping (Requiere server restart)
Config.UseCustomWeaponDamages = true        -- Custom weapon damages true = Yes | false = no. (Requiere server restart)

Config.UseRecoil = true                     -- Enable custom recoil
Config.RightLeftRecoil = true               -- true = Right Recoil | false = Left Recoil.
