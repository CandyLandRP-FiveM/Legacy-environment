...
AddEventHandler('housing:server:buyHouse', function(house, isCredit)
    ...
    if Config.LimitOfHouses == 0 or houses < Config.LimitOfHouses then
        ...
        if (Balance >= HousePrice) or (isCredit and Balance >= eq) then -- here
            ...
            MySQL.Async.execute("INSERT INTO `player_houses` (`house`, `identifier`, `citizenid`, `insideId`, `keyholders`, `decorations`, `stash`, `houseID`, `outfit`, `logout`, `decorateStash`, `charge`, `credit`, `creditPrice`, `timer`) VALUES ('" .. house .. "', NULL, '" .. pData.identifier .. "', NULL, NULL, '{}', NULL, '" .. house_ID .. "', NULL, NULL, NULL, NULL, '" ..prices.. "', '" .. eq .. "', '" .. Config.CreditTime .. "')",{})
