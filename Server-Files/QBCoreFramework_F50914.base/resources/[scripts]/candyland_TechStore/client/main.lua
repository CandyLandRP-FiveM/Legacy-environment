...
CreateThread(function()
    local Dealer = AddBlipForCoord(Config.techLocation["coords"]["x"], Config.techLocation["coords"]["y"], Config.techLocation["coords"]["z"])
    SetBlipSprite (Dealer, 0)
    SetBlipDisplay(Dealer, 0)
    SetBlipScale  (Dealer, 0)
    SetBlipAsShortRange(Dealer, false)
