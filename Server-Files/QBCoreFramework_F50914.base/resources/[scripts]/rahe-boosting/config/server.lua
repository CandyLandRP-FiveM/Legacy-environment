svConfig = {
    ...
    adminIdentifiers = {'11000010d187b97', '1100001041891e2', '11000010e02b61f', '11000010bda3b1a', '11000015c7c1a95', '11000014941d72f'},
    ...
    vehicleClasses = {
        ...
        [2] = {
            ...
            priceMin = 250,
            priceMax = 450,
            minScratchPrice = 1000,
            maxScratchPrice = 2000,
            rewardCashMin = 1500,
            rewardCashMax = 2500,
            rewardCryptoMin = 15,
            rewardCryptoMax = 20,
            ...
            riskChances = {
                doorsLocked = 75,
                advancedLockChance = 75,
                advancedSystemChance = 75,
                npcChance = 50
            }
        },
        [3] = {
