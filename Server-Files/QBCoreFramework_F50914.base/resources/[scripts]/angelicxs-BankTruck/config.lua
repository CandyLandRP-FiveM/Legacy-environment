...
Config.RequiredNumberLEO = 3				-- Minimum number of LEO needed for robbery to start when Config.RequireMinimumLEO = true
...
Config.ArmExplosionTimer = 15				-- Time in seconds it takes for explosion to arm and destory truck to loot it
...
-- Reward Config
Config.GoldBarChance = 50					-- Chance to receive gold bars instead of marked bills
Config.GoldBarName = 'goldbar'				-- Name of gold bar item
Config.GoldBarMin = 10						-- Minimum number of gold bars recevied
Config.GoldBarMax = 30						-- Maximum number of gold bars received
Config.MarkedBillName = 'markedbills'		-- Name of marked bill item
Config.MarkedBillMinNumberAmount = 5		-- Minimum number of marked bills received
Config.MarkedBillMaxNumberAmount = 50		-- Maximum number of marked bills received
...
Config.RareLootChance = 5					-- Chance to receive rare item in addition to normal reward
Config.RareLootItem = 'accesscard'	        -- Name of rare loot item
...
Config.StartPed = vector4(-2351.44, 3252.54, 92.9, 324.88)	-- Location for starting NPC
Config.StartModel = 'csb_cletus'                   	-- Model of starting NPC
