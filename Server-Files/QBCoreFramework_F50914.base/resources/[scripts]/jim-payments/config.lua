...
Config = {
	...
	PhoneType = "qs-smartphone", -- Change this setting to make invoices work with your phone script [still testing this currently]
						-- "qb" for qb-phone
						-- "gks"" for GKSPhone
	...
	Jobs = {
		...
		['floki'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.10, },
		['upandatom'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.10, },
		['pdm'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.10, },
		['toxicos'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.10, },
		['phaq'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.10, },
		['pinkcage'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.10, },
		['tavern'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.10, },
		['pops'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.10, },
		['petshop'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.10, },
		['arcade'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.10, },
		...
		['lawyer'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.10, },
		['cityhall'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.10, },
		['nachodaddy'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.10, },
		['pawn'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.10, },
		['rws'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.10, },
    ...
    CustomCashRegisters = {
		["floki"] = { -- Player job role restriction
	      { coords = vector4(289.57, -1165.84, 29.20, 99.39), prop = false, },
		},
         ["toxicos"] = { -- Player job role restriction
	      { coords = vector4(843.11, -986.70, 26.50, 87.91), prop = true, },
		},
		["coolbeans"] = { -- Player job role restriction
		  { coords = vector4(-1200.96, -1136.92, 7.85, 179.0), prop = false, },
	    },
		["upandatom"] = { -- Player job role restriction
		  { coords = vector4(89.16, 288.83, 110.13, 115.0), prop = false, },
		  { coords = vector4(89.7, 287.67, 110.13, 115.0), prop = false, },
		  { coords = vector4(90.25, 286.48, 110.13, 115.0), prop = false, },
		  { coords = vector4(94.44, 284.62, 110.31, -120.00), prop = false, },
	    },
		["hornys"] = { -- Player job role restriction
		  { coords = vector4(1250.75, -359.44, 68.99, 165.0), prop = false, },
		  { coords = vector4(1249.39, -359.08, 68.99, 165.0), prop = false, },
		  { coords = vector4(1248.12, -358.73, 68.99, 165.0), prop = false, },
		  { coords = vector4(1252.9, -357.55, 68.99, -15.0), prop = false, },
	    },
		["nachodaddy"] = { -- Player job role restriction
		  { coords = vector4(983.72, -1386.00, 31.69, 30.00), prop = false, },
	    },
		["pinkcage"] = { -- Player job role restriction
		  { coords = vector4(333.78, -200.56, 54.01, 160.0), prop = false, },
		  { coords = vector4(335.98, -201.36, 54.01, 160.0), prop = false, },
	    },
		["phaq"] = { -- Player job role restriction
		  { coords = vector4(-171.34, 295.02, 93.8, 270.0), prop = false, },
	    },
		["tavern"] = { -- Player job role restriction
		  { coords = vector4(1230.4, -415.34, 67.91, 345.0), prop = false, },
	    },
		["pops"] = { -- Player job role restriction
		  { coords = vector4(1775.49, 3322.42, 41.53, 29.2), prop = false, },
	    },
		["arcade"] = { -- Player job role restriction
		  { coords = vector4(2374.94, 3070.41, 33.44, 10.0), prop = false, },
	    },
		["petshop"] = { -- Player job role restriction
		  { coords = vector4(-659.71, -937.51, 22.88, 197.52), prop = false, },
	    },
		["pawn"] = { -- Player job role restriction
		  { coords = vector4(173.59, -1317.66, 29.45, -104.09), prop = false, },
	    },
	  },
	...
	FineJobs = {
		['police'] = { Commission = 0.06, },
		['ambulance'] = { Commission = 0.10, },
		['lawyer'] = { Commission = 0.10, },
		['cityhall'] = { Commission = 0.10, },
	},
