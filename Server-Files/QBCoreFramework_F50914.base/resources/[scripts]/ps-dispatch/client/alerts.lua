...
local function StoreRobberyRegister()
    local coords = GetEntityCoords(cache.ped)

    local dispatchData = {
        message = locale('storerobberyregister'),
        codeName = 'storerobberyregister',
        code = '10-90',
        icon = 'fab fa-artstation',
        priority = 2,
        coords = coords,
...
exports('StoreRobberyRegister', StoreRobberyRegister)

local function StoreRobberySafe()
    local coords = GetEntityCoords(cache.ped)

    local dispatchData = {
        message = locale('storerobberysafe'),
        codeName = 'storerobberysafe',
        code = '10-90',
        icon = 'fab fa-artstation',
        priority = 2,
        coords = coords,
...
exports('StoreRobberySafe', StoreRobberySafe)

local function StoreRobberyLiquor()
    local coords = GetEntityCoords(cache.ped)

    local dispatchData = {
        message = locale('storerobberyliquor'),
        codeName = 'storerobberyliquor',
        code = '10-90',
        icon = 'fab fa-artstation',
        priority = 2,
        coords = coords,
...
exports('StoreRobberyLiquor', StoreRobberyLiquor)
