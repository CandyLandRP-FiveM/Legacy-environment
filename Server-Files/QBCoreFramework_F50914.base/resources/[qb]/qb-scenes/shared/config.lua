...
Config.CreateSceneKey = 'f9' -- https://docs.fivem.net/docs/game-references/input-mapper-parameter-ids/keyboard/
Config.DeleteSceneKey = 'f10' -- https://docs.fivem.net/docs/game-references/input-mapper-parameter-ids/keyboard/
