...
Config.FuelResource = 'cdn-fuel'                            -- (cdn-fuel | lj-fuel | cdn-fuel)<--Which fuel reource are you using?
...
Config.MaxErrors       = 7                                   -- Max Amount of Errors for Driving Test before Failing.
Config.PlayerCoordsAfterTest = vector4(233.93, -1387.85, 30.55, 148.83) -- Teleport Players to Coords after passing/failing drivers test.
...
Config.Amount = {
    ['theoritical'] = 100,                                     --theoretical test payment amount(If Config.DriversTest = false then the theoritical test will go to the drivers test amount.)
    ['driver']      = 250,                                     --Drivers Test Payment Amount
    ['cdl']         = 500,                                    --CDL Test Payment Amount
    ['bike']        = 250                                     -- Bike Test Payment
}
