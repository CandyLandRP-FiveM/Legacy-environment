...
Config.DelayBetweenCarjackings = 0 -- Time before you can carjack again
...
Config.SharedKeys = { -- Share keys amongst employees. Employees can lock/unlock any job-listed vehicle
    ['police'] = { -- Job name
        requireOnduty = true,
        vehicles = {
	    'pigeonp', -- Vehicle model
	    'velox', -- Vehicle model
        'nkstx', -- Vehicle model
        'nkvstr', -- Vehicle model
        'nkgranger2', -- Vehicle model
        'nktorrence', -- Vehicle model
        'nkcruiser', -- Vehicle model
        'nkbison', -- Vehicle model
        'nkfugitive', -- Vehicle model
        'nkcaracara2', -- Vehicle model
	}
    },
