...
ItemList = {
    ...
    -- Random Box
    ['random_weapon_box']            = {
        ['name'] = 'random_weapon_box',
        ['label'] = 'Random Weapon Box',
        ['weight'] = 0,
        ['type'] = 'item',
        ['image'] = 'random_weapon_box.png',
        ['unique'] = true,
        ['useable'] = true,
        ['shouldClose'] = true,
        ['combinable'] = nil,
        ['description'] = 'This box can give you many items, do you dare to try your luck?'
    },
    ['random_weapon_tint']           = {
        ['name'] = 'random_weapon_tint',
        ['label'] = 'Random Weapon Tint',
        ['weight'] = 0,
        ['type'] = 'item',
        ['image'] = 'random_weapon_tint.png',
        ['unique'] = true,
        ['useable'] = true,
        ['shouldClose'] = true,
        ['combinable'] = nil,
