...
local props = {
	---- ** Drugs ** ----
	-- Weed
	["nil"] = { model = "bkr_prop_weed_drying_02a", hash = joaat("bkr_prop_weed_drying_02a"), tier = 1, yr = 90.0 }, -- This is more of an item that deserves a

	-- meth
	["nil"] = { model = "hei_prop_pill_bag_01", hash = joaat("hei_prop_pill_bag_01"), tier = 3 },

	-- Contraband
	["nil"] = { model = "prop_money_bag_01", hash = joaat("prop_money_bag_01"), tier = 3, x = -0.47, zr = 0 }, -- If you put any x,y,z,xr,yr,zr it will offset it from the slots to make it fit perfectly
	...
	["weapon_nordicaxe"] = { model = "w_me_battleaxe", hash = joaat("weapon_battleaxe"), tier = 2 },
	["weapon_kratos"] = { model = "w_me_crowbar", hash = joaat("weapon_crowbar"), tier = 2 },
	...
	-- I use these for my house robbery when they steal the objects --
		...
		["nil"] =  { carry = true, model = "hei_prop_heist_weed_block_01", bone = 28422, x = 0.01, y = -0.02, z = -0.12, xr = 0.0,
